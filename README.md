...
The PTAT correction current is set by two BJTs biased at 8:1, producing $\Delta V_{BE} = V_T \cdot \ln(n)$ across R1. Hence, the Brokaw topology suits SKY130's imprecise, low-β PNPs (β = 10–20) because accuracy depends on BJT matching rather than absolute device parameters. 
The ratio R2/R1 scales this to cancel the linear drift of V_BE at the output:[^2]
