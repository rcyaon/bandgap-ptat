...
N -340 50 -340 70 {lab=VP1}
N -340 130 -340 150 {lab=VE1}
N -460 -90 -440 -90 {lab=VP1}
N -520 -70 -440 -70 {lab=VE1}
N -140 -70 -120 -70 {lab=VBase}
N 40 100 40 120 {lab=VE1}
N -40 -110 150 -110 {lab=VBase}
N -220 180 -190 180 {lab=VDD}
N -190 120 -190 150 {lab=#net1}
N -150 180 -130 180 {lab=GND}
N -190 210 -190 240 {lab=VDD}
...
C {sky130_fd_pr/res_high_po_0p69.sym} -340 100 2 0 {name=R1
L=400
...
C {lab_wire.sym} -300 100 2 0 {name=p13 sig_type=std_logic lab=GND}
C {lab_wire.sym} -340 50 0 0 {name=p14 sig_type=std_logic lab=VP1}
C {lab_wire.sym} -340 150 2 0 {name=p15 sig_type=std_logic lab=VE1}
...
C {sky130_fd_pr/pfet_01v8.sym} -170 180 2 0 {name=M3
W=1
L=8
nf=1
mult=1
...
C {lab_wire.sym} -220 180 0 0 {name=p5 sig_type=std_logic lab=VDD}
C {lab_wire.sym} -130 180 2 0 {name=p9 sig_type=std_logic lab=GND}
C {lab_wire.sym} -190 240 2 0 {name=p11 sig_type=std_logic lab=VDD}
C {lab_wire.sym} -190 120 0 0 {name=p19 sig_type=std_logic lab=VBase}
