...
N 350 100 420 100 {lab=Vref}
N 20 100 20 150 {lab=Vref}
N 20 150 370 150 {lab=Vref}
N 370 100 370 150 {lab=Vref}
...
C {opin.sym} 420 100 0 0 {name=p2 lab=Vref}
...
C {lab_wire.sym} -160 290 0 0 {name=p11 sig_type=std_logic lab=VREF_RAW}
C {lab_wire.sym} -160 390 0 0 {name=p12 sig_type=std_logic lab=GND}
C {ota.sym} 200 100 0 0 {name=x1}
C {lab_wire.sym} -20 80 0 0 {name=p13 sig_type=std_logic lab=VREF_RAW}
