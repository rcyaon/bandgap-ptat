...
N -430 20 -430 40 {lab=VP1}
N -470 70 -450 70 {lab=VP1}
N -430 100 -430 120 {lab=VP1}
N -430 130 -430 150 {lab=VP1}
N -470 180 -450 180 {lab=VP1}
N -430 210 -430 230 {lab=VP1}
...
C {sky130_fd_pr/res_high_po_0p69.sym} -430 70 0 0 {name=R2
L=100
model=res_high_po_0p69
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_high_po_0p69.sym} -430 180 0 0 {name=R3
L=100
model=res_high_po_0p69
spiceprefix=X
mult=1}
C {lab_wire.sym} -430 20 0 0 {name=p5 sig_type=std_logic lab=VP1}
C {lab_wire.sym} -470 70 0 0 {name=p9 sig_type=std_logic lab=VP1}
C {lab_wire.sym} -470 180 0 0 {name=p11 sig_type=std_logic lab=VP1}
C {lab_pin.sym} -430 230 0 0 {name=p19 sig_type=std_logic lab=VP1}
C {lab_pin.sym} -430 120 0 0 {name=p22 sig_type=std_logic lab=VP1}
C {lab_pin.sym} -430 130 2 0 {name=p25 sig_type=std_logic lab=VP1}
